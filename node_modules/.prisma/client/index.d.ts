...
export namespace Prisma {
  ...
  */
  ...
  export type IncidentGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Incident ? Incident[P] : never
  } 
    : Incident
  : Incident
  ...
  export type User_ProfileScalarWhereWithAggregatesInput = {
    ...
    cityState?: StringWithAggregatesFilter | string
  ...
  export type User_ProfileUpdateInput = {
    ...
    cityState?: StringFieldUpdateOperationsInput | string
